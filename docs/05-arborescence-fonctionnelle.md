...
Les anciennes URL `/structures` et `/devis-structure` redirigent vers `/contact`. Elles ne doivent apparaître ni dans la navigation, ni dans le sitemap, ni dans les contenus.
