...
<template>
  <article class="group flex h-full flex-col overflow-hidden rounded-[1.75rem] bg-white shadow-soft transition-transform duration-300 hover:-translate-y-1">
    <img :src="offering.image" :alt="offering.title" class="block aspect-[4/3] w-full object-cover transition-transform duration-500 group-hover:scale-105" loading="lazy" decoding="async" />
